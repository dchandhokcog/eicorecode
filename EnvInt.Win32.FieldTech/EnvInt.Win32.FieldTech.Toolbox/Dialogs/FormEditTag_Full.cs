...
{
    public partial class FormEditTag_Full : Form
    {
        ...
        public FormEditTag_Full(Point startPosition)
        {
            InitializeComponent();
        ...
        {
            if (!string.IsNullOrEmpty(Convert.ToString(nonXTag)))
            {
        ...
        private void buttonChildAdd_Click(object sender, EventArgs e)
        {
            ...
            if (textBoxPreviousTag.Text != "")
            {
                ...
                //co.PreviousTag = textBoxPreviousTag.Text + "." + Globals.getTagPoint(listViewChildren.Items.Count + 1, 1);
            }
        ...
        private void FormEditTag_Full_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void FormEditTag_Full_VisibleChanged(object sender, EventArgs e)
        {
            if (_imageFileStream != null) _imageFileStream.Dispose();
        }
