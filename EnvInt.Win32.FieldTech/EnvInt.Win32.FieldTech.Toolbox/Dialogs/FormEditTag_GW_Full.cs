...
namespace EnvInt.Win32.FieldTech
{
    ...
    public partial class FormEditTag_GW_Full : Form
    {
        ...
        public FormEditTag_GW_Full(Point startPosition)
        {
            InitializeComponent();
...
//                    }
        ...
        private void setFormValues(bool existingTag)
        {
            ...
            if (_currentTaggedComponent.Inspected)
            {
                labelInspection.Text = _currentTaggedComponent.InspectionReading + " PPM by " + _currentTaggedComponent.InspectionInspector;
            }
            else
            {
                labelInspection.Text = "None";
        ...
        private bool validateFormData()
        {
            ...
            if (!string.IsNullOrEmpty(textBoxPreviousTag.Text))
            {
                ...
                //{
                    LDARComponent ldc = Globals.CurrentProjectData.LDARData.ExistingComponents.Where(c => c.ComponentTag == textBoxPreviousTag.Text && c.TagExtension == textBoxOTExtension.Text).FirstOrDefault();
            ...
            foreach (ListViewItem itm in listViewChildren.Items)
            {
                ...
                {
                    if (!Properties.Settings.Default.AllowDuplicateLocation) errorList.Add("Duplicate location descriptions exist");
                    break;
                }
