...
{
    public partial class FormChildObject_GW : Form
    {
        ...
        public string PreviousTagExtension
        {
            get
            {
                return textBoxPreviousTagExtension.Text;
            }
            set
            {
                textBoxPreviousTagExtension.Text = value;
            }
        }
        ...
        public FormChildObject_GW(string location)
        {
            InitializeComponent();
            ...
            hideforChineseVersion();

        }

        private void hideforChineseVersion()
        {
            if (Globals.isProductChinese)
            {
               label2.Visible = textBoxPreviousTag.Visible = label5.Visible = textBoxPreviousTagExtension.Visible = panel2.Visible = false;
            }
        }
        ...
        public void setTypeList(List<LDARComponentClassType> typeList)
        {
            ...
            comboBoxComponentType.Items.Add("");
            ...
            if (Properties.Settings.Default.LastChildComponentType.Trim() != "")
            {
                comboBoxComponentType.SelectedText = Properties.Settings.Default.LastChildComponentType.Trim();
            }
        ...
        public void setComponent(ChildComponent child)
        {
            ...
            textBoxPreviousTagExtension.Text = child.PreviousTagExtension;
            if (child.Inspected)
            {
        ...
        private void buttonOK_Click(object sender, EventArgs e)
        {
            if (validateForm())
            {
                Properties.Settings.Default.LastChildComponentType = comboBoxComponentType.SelectedText;
        ...
        private void FormChildObject_Activated(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(comboBoxComponentType.Text) && comboBoxComponentType.Items.Count==0)
            {
                ...
                if (string.IsNullOrEmpty(comboBoxComponentType.Text) && comboBoxComponentType.Items.Count == 0) comboBoxComponentType.Text = "FLANGE";
            }
        ...
        private void comboBoxComponentType_LocationUpdate(object sender, EventArgs e)
        {
            if (Globals.isProductChinese)
            {
                //LocationDescription = ParentLocation + " " + (sender as ComboBox).Text;
            }
        }
    }
}
