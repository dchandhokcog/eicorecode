...
namespace EnvInt.Win32.EiMOC.Library
{
    ...
    internal class Capture : ISampleGrabberCB, IDisposable
    {
        ...
        public Capture(int iDeviceNum, int iWidth, int iHeight, short iBPP, Control hControl)
        {
            ...
            try
            {
                ...
                //TODO: This shouldn't be hard coded, but these settings worked with my webcam.
                SetupGraph(capDevices[iDeviceNum], 640, 480, iBPP, hControl);
